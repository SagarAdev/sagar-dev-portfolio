                ...
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className='my-6 md:my-0 md:w-[50%] md:ml-10 md:px-5'>
                        ...
                        <div className="flex flex-wrap justify-around w-[100%] pt-5 md:py-5">
                            <SkillCard imgUrl="./htmlIcon.svg" title="HTML5" />
                            <SkillCard imgUrl="./cssIcon.svg" title="CSS3" />
                            <SkillCard imgUrl="./jsIcon.svg" title="Javascript" />
                            <SkillCard imgUrl="./reactIcon.svg" title="React.js" />
                            <SkillCard imgUrl="./tailwindIcon.svg" title="Tailwind CSS" />
                            <SkillCard imgUrl="./githubIcon.svg" title="Github" />
                            <SkillCard imgUrl="./responsiveIcon.svg" title="Responsive Design" />
                        </div>
                    </div>
                </div>
