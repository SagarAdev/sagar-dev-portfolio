                ...
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className='my-6 md:my-0 md:w-[50%] md:ml-10 md:px-5'>
                        ...
                        <div className="flex flex-wrap justify-around w-[100%] pt-5 md:py-5">
                            <SkillCard imgUrl="/assets/htmlIcon.svg" title="HTML5" />
                            <SkillCard imgUrl="/assets/cssIcon.svg" title="CSS3" />
                            <SkillCard imgUrl="/assets/jsIcon.svg" title="Javascript" />
                            <SkillCard imgUrl="/assets/reactIcon.svg" title="React.js" />
                            <SkillCard imgUrl="/assets/tailwindIcon.svg" title="Tailwind CSS" />
                            <SkillCard imgUrl="/assets/githubIcon.svg" title="Github" />
                            <SkillCard imgUrl="/assets/responsiveIcon.svg" title="Responsive Design" />
                        </div>
                    </div>
                </div>
